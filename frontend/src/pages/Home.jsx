...
export default function Home() {
  ...
  useEffect(() => {
    ...
    Promise.all([apiClient.get('/products'), getAllStores()]).then(([productsResponse, storesResponse]) => {
      setProducts(mergeShopProducts(Array.isArray(productsResponse.data) ? productsResponse.data : []));
      if (Array.isArray(storesResponse) && storesResponse.length) setStores(withStoreLogos(storesResponse));
